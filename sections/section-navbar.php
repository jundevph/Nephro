...
<nav class="navbar bg-white sticky top-0 z-50 shadow-sm" id="main-nav">
    <div class="max-w-[85rem] mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div class="hidden lg:flex items-center gap-10">
            ...
            <a href="#about" class="text-[15px] font-bold text-[#204185] hover:text-[#1CA0AA] transition-colors">About Us</a>
            <a href="#facilities" class="text-[15px] font-bold text-[#204185] hover:text-[#1CA0AA] transition-colors">Our Facilities</a>
            <a href="#news" class="text-[15px] font-bold text-[#204185] hover:text-[#1CA0AA] transition-colors">News &amp; Events</a>
            <a href="#"
    ...
    <div class="mobile-menu lg:hidden bg-white border-t" id="mobile-menu">
        <div class="px-4 py-6 flex flex-col gap-4 text-center">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="text-base font-bold text-[#1CA0AA] hover:text-[#14838b] transition-colors">Home</a>
            <a href="#about" class="text-base font-bold text-[#204185] hover:text-[#1CA0AA] transition-colors">About Us</a>
            <a href="#facilities" class="text-base font-bold text-[#204185] hover:text-[#1CA0AA] transition-colors">Our Facilities</a>
            <a href="#news" class="text-base font-bold text-[#204185] hover:text-[#1CA0AA] transition-colors">News &amp; Events</a>
